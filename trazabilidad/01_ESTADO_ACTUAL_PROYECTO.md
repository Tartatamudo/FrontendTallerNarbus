...
| **Módulo Mecánicos: Dashboard de Revisiones** | `src/mecanicos/revisiones/DashboardMecanico.tsx` | `COMPLETADO` | Pestañas de "Solicitudes Pendientes" y "Mis Trabajos Asignados". Detalle completo de orden, visualización de averías con estados resueltos/bloqueados, cuadrilla con minutos cronometrados y bitácora cronológica con comentarios categorizados. |
